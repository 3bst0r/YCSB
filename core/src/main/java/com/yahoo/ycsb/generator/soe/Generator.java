...
public abstract class Generator {
  ...
  public void buildCompoundMultipleArrayPredicate() {
    ...
    final String ageStorageKey = buildStorageKey(SOE_DOCUMENT_PREFIX_CUSTOMER,
        SOE_FIELD_CUSTOMER_CHILDREN,
        SOE_FIELD_CUSTOMER_CHILDREN_OBJ_AGE);
    final String age = getVal(ageStorageKey);
  ...
  public void buildLiteralArrayPredicate() {
    ...
    final String storageKey = buildStorageKey(SOE_DOCUMENT_PREFIX_CUSTOMER,
        arrayFieldIdentifier(SOE_FIELD_CUSTOMER_DEVICES));
