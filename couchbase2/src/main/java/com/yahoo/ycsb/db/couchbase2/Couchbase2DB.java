 ...
 * </ul>
 */
public abstract class Couchbase2DB extends DB {
  ...
  private static final CouchbaseLogger LOGGER = CouchbaseLoggerFactory.getInstance(Couchbase2DB.class);
   ...
   */
  protected void waitForMutationResponse(final Observable<? extends Document<?>> input) {
    if (!syncMutResponse) {
